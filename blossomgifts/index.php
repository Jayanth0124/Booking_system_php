...
?>
<h1>Welcome to BlossomGifts</h1>
<?php if (isset($_SESSION['user_id'])): ?>
    <p>Hello, <?php echo htmlspecialchars($_SESSION['username']); ?>! | <a href="cart.php">My Cart</a> | <a href="my_account.php">My Account</a> | <a href="logout.php">Logout</a></p>
<?php else: ?>
...
<?php while ($product = $products->fetch_assoc()): ?>
    <div style="display: inline-block; width: 200px; border: 1px solid #ccc; padding: 10px; margin: 10px; vertical-align: top;">
