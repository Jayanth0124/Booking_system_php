...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 17, 2025 at 09:53 AM
...
INSERT INTO `orders` (`id`, `user_id`, `shipping_address_id`, `total_amount`, `order_date`, `status`) VALUES
(1, 2, 1, 24.00, '2025-09-17 07:48:38', 'Shipped');
...
INSERT INTO `products` (`id`, `name`, `description`, `price`, `category_id`, `sub_category_id`, `image_path`, `stock_quantity`) VALUES
(1, 'cake', 'adEF', 24.00, 2, 1, 'uploads/SIMATS_CGPA_Result (3).png', 10);
...
INSERT INTO `shipping_addresses` (`id`, `user_id`, `full_name`, `address_line1`, `city`, `pincode`, `phone_number`) VALUES
(1, 2, 'oiuytr', 'yttrse', 'Eluru', '521105', '1234567');
...
(1, 'admin', 'admin@cake.com', 'admin123', 'admin'),
