...
$cart_items = $conn->query("SELECT c.id, p.name, p.price, c.quantity, c.size FROM cart c JOIN products p ON c.product_id = p.id WHERE c.user_id = $user_id");
?>
<h1>Your Cart</h1>
<table border="1">
    <tr><th>Product</th><th>Size</th><th>Price</th><th>Quantity</th><th>Total</th><th>Action</th></tr>
