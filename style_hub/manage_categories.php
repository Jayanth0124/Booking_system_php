...
<body>
    ...
    <form method="post">
        <input type="text" name="category_name" placeholder="e.g., Men" required>
    ...
    <form method="post">
        ...
        Sub-Category Name:
        <input type="text" name="sub_category_name" placeholder="e.g., Casual Wear" required>
    ...
    <table border="1">
        ...
        <tr>
            ...
            <td><a href="?delete_cat=<?php echo $cat['id']; ?>" onclick="return confirm('Deleting this will also delete all its sub-categories. Are you sure?')">Delete</a></td>
        </tr>
        <?php endwhile; ?>
    </table>
