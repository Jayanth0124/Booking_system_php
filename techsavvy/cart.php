...
$cart_items = $conn->query("SELECT p.name, p.price, c.quantity, p.id as product_id FROM cart c JOIN products p ON c.product_id = p.id WHERE c.user_id = $user_id");
?>
...
<table border="1">
    ...
    <tr>
        ...
        <td><a href="?remove_id=<?php echo $item['product_id']; ?>">Remove</a></td>
    </tr>
