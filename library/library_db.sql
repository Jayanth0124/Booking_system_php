...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 16, 2025 at 05:17 PM
...
(1, 'admin', 'admin123', 'admin@library.com', 'admin', '2025-09-16 14:42:43'),
(2, 'student', '$2y$10$JkUc4FF6Mmr/PoAk1LCgzu6VS7PHaJRXgeKTYzaDvjGbpBYhq1uEW', 'jayanthdonavalli0124@gmail.com', 'user', '2025-09-16 15:00:40');
...
ALTER TABLE `fines`
  ...
  ADD CONSTRAINT `fines_ibfk_2` FOREIGN KEY (`issued_book_id`) REFERENCES `issued_books` (`id`);
